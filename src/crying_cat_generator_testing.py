...
"""
This script will transform all cats located at the folder 'samples' in a crying cat, and results will be
...
for f in file_list:
  ...
  cv2.imwrite('results/%s_result%s' % (filename, ext), result_img)
